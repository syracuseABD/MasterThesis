...
\subsection{States}
\begin{tabbing}
\HOLFreeVar{slState} = \=\HOLConst{MOVE_TO_ORP} \\
				   	\>\HOLTokenBar{} \HOLConst{PLT_FORM} \\
					\>\HOLTokenBar{} \HOLConst{PLT_MOVE} \\
					\>\HOLTokenBar{} \HOLConst{PLT_SECURE_HALT}\\
        					\>\HOLTokenBar{} \HOLConst{COMPLETE}
\end{tabbing}

\subsection{Outputs}
\begin{tabbing}
\HOLFreeVar{slOutput} = \=\HOLConst{MoveToORP} \\
					\>\HOLTokenBar{} \HOLConst{PLTForm} \\
					\>\HOLTokenBar{} \HOLConst{PLTMove} \\
					\>\HOLTokenBar{} \HOLConst{PLTSecureHalt}\\
         				\>\HOLTokenBar{} \HOLConst{Complete} \\
					\>\HOLTokenBar{} \HOLConst{unAuthorized} \\
					\>\HOLTokenBar{} \HOLConst{unAuthenticated}
\end{tabbing}
...
\paragraph*{HOL Definition for inputOK}
The \glsentryshort{hol} definition for inputOK uses pattern matching.  This follows the same logic as \textit{inputOK} for ssmPB.  It adds one additional pattern for the PlatoonSergeant.
...
This follows the same logic as \textit{inputOK} for ssmPB.  It adds one additional pattern for the PlatoonSergeant.
