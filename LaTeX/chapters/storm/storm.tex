...
STAMP is an accident-causality model.  It incorporates a system-theoretic perspective that views accidents as dynamic control problems by thinking about safety constraints, hierarchical control structures, and process models \cite{saferworld}. STAMP is not an approach to accident analysis, it is a way of thinking about safety engineering that should be included in accident analysis and safety and security design techniques.
...
System-theoretic Process Analysis (STPA) implements the STAMP model. 
...
It is a methodology for a applying systems-level thinking to safety engineering.  I
