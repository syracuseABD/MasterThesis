...
\Glspl{wff} valid statements or expressions in the \glsentryshort{acl}.  All \glsentryshort{ACL} statements or requests must be a \glsentryshort{wff}.  The text book defines the set of \glsentryshortpl{wff} using the identifier \textbf{Form}:
